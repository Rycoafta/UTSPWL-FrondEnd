...
const ProductPage = () => (
  <SidebarUser>
    <div className="flex flex-col bg-slate-50 p-4 rounded shadow-lg h-full">
      <p className="text-4xl text-purple-600 font-bold">User</p>
      <div className="flex justify-end mt-20 mb-6">
        <button className="">
          <a
            className="flex justify-center py-2 item-center w-40 h-9 bg-purple-600 text-white rounded-lg  text-sm"
            href="/user/add-user"
          >
            Add User
          </a>
